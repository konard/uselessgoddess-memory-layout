    ...
    async def execute(self, ctx: Context):
        ...
        for party in new_party_schema:
            for account in party.all:
                ...
                await CS2Controller.click_async(**game_constants.open_side_bar, account=account)
                await asyncio.sleep(0.3)
                print("clicking exit")
                await CS2Controller.click_if_exists_async("resources/img/exit.png", account, 0.9)
                await asyncio.sleep(0.3)
